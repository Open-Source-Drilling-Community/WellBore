...
public static class WellBoreRestMcpToolRegistrations
{
    public static IServiceCollection AddWellBoreRestMcpTools(this IServiceCollection services)
    {
        ...
        services.AddLegacyMcpTool("well_bore_topology_update", "Replace only WellID, RigID, and sidetrack topology without resending details or assignments. ParentWellBoreID is synchronously validated locally, cycles and cross-Well parent links are rejected, while WellID and RigID remain externally owned references.", McpToolArgumentHelpers.CreateWellBoreTopologyMutationSchema(),
